...
namespace jaccen {
    ...
    void GLErrorCheck(const char* message)
    {
        ...
        case GL_INVALID_ENUM:
            ECS_LOG("GL_INVALID_ENUM : %s\n", message);
            break;
        case GL_INVALID_VALUE:
            ECS_LOG("GL_INVALID_VALUE : %s\n", message);
            break;
        case GL_INVALID_OPERATION:
            ECS_LOG("GL_INVALID_OPERATION : %s\n", message);
            break;
#ifndef GL_ES_VERSION_2_0
        case GL_STACK_OVERFLOW:
            ECS_LOG("GL_STACK_OVERFLOW : %s\n", message);
            break;
        case GL_STACK_UNDERFLOW:
            ECS_LOG("GL_STACK_UNDERFLOW : %s\n", message);
            break;
#endif
        case GL_OUT_OF_MEMORY:
            ECS_LOG("GL_OUT_OF_MEMORY : %s\n", message);
            break;
        case GL_NO_ERROR:
            break;
        }
    ...
    {
        ECS_LOG("%s =\n", name.c_str());
        ECS_LOG("   | %10.5f, %10.5f, %10.5f, %10.5f |\n", m4[0][0], m4[1][0], m4[2][0], m4[3][0]);
